    ...
    <div className="site">
      ...
      <main className="main">
        <section id="preface" className="section">
          ...
          <p>Text never starts exactly from the edge of the textbox. Non-constant left-align may create visual inconsistency on bigger font-sizes. This package solves that issue.</p>
